...
void test_validate_my_username()
{
     ...
     */
    TEST_ASSERT_EQUAL_STRING_MESSAGE(my_username(), malloc_username_from_conf_file(), "The username in conf/username.txt does not match the on in autotest-validate.c");
}
